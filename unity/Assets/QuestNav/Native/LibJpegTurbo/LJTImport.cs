...
namespace LibJpegTurboUnity
{
    internal static class LJTImport
    {
        ...
        {
            return (dimension * ljtScalingFactor.Num + ljtScalingFactor.Denom - 1)
                / ljtScalingFactor.Denom;
        }
            ...
            switch (IntPtr.Size)
            {
                ...
                default:
                    throw new InvalidOperationException(
                        "Invalid platform. Can not find proper function"
                    );
            }
        }
