...
```bash
    mkdir unity\Assets\QuestNav\Generated
    protoc --proto_path=protos --csharp_out=unity\Assets\QuestNav\Generated protos\*.proto
```
  </TabItem>
  <TabItem value="linux-mac" label="Linux/Mac">
```bash
    mkdir -p unity/Assets/QuestNav/Generated
    protoc --proto_path=protos --csharp_out=unity/Assets/QuestNav/Generated protos/*.proto
```
  </TabItem>
</Tabs>
...
### Step 8: Import the Project into Unity
...
### Step 9: Configure Build Settings for Android
...
### Step 10: Set Up Project for Meta Quest
...
### Step 11: Install Formatting Tools
...
### Step 12: Generate Visual Studio project (Optional)
:::tip
